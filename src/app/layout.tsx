...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <meta name="google-adsense-account" content="ca-pub-9806436984867634" />
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9806436984867634" crossOrigin="anonymous"></script>
      </head>
      <body>
        <Header />
